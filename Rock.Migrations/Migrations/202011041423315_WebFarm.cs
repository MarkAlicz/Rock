...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class WebFarm : Rock.Migrations.RockMigration
    {
        /// <summary>
        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        WebFarmEnabled = c.Boolean(nullable: false),
                        LeadershipPollingIntervalLowerLimitSeconds = c.Int(nullable: false),
                        LeadershipPollingIntervalUpperLimitSeconds = c.Int(nullable: false),
                        CreatedDateTime = c.DateTime(),
                        ModifiedDateTime = c.DateTime(),
                        CreatedByPersonAliasId = c.Int(),
                        ModifiedByPersonAliasId = c.Int(),
        ...
        {
            DropForeignKey("dbo.WebFarmSettings", "ModifiedByPersonAliasId", "dbo.PersonAlias");
            DropForeignKey("dbo.WebFarmSettings", "CreatedByPersonAliasId", "dbo.PersonAlias");
            ...
            DropIndex("dbo.WebFarmSettings", new[] { "Guid" });
            DropIndex("dbo.WebFarmSettings", new[] { "ModifiedByPersonAliasId" });
            DropIndex("dbo.WebFarmSettings", new[] { "CreatedByPersonAliasId" });
